...
export function ScheduleResults({
  ...
  const { statusMap: realtimeStatusMap, canceledByStartTime, lastUpdated, isError: realtimeIsError } = useTripRealtimeStatusMap(fromStation, toStation, filteredTrips);
